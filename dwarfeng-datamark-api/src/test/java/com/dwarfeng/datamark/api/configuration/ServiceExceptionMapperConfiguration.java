package com.dwarfeng.datamark.api.configuration;
...
public class ServiceExceptionMapperConfiguration {
    ...
    public MapServiceExceptionMapper mapServiceExceptionMapper() {
        ...
        destination = com.dwarfeng.datamark.sdk.exception.ServiceExceptionHelper.putDefaultDestination(destination);
